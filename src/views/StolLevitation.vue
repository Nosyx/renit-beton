    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/nabytok/stol-levitation">Stôl LEVITATION</a></li>
        </ul>
      </div>
    </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
            Minimalistický štýlový stolík z pohľadového betónu sa hodí do každého priestoru. Betón je vysoko odolný a je vďačným materiálom na údržbu. Tenké nohy stola vytvárajú z niektorých uhlov pocit, akoby levitoval. Stôl LEVITATION ponúkame vo viacerých farebných prevedeniach.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "../src/assets/stol-levitation.jpg",
      ],
