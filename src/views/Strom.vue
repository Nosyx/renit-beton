    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-dekoracia-strom-2ks">Betónová dekorácia STROM-2ks</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová dekorácia STROM-2ks</h2>
          <div class="underline"></div>
          <p>
            <br>
            Ozdobujte svoj interiér počas celého roka. Ponorte sa do štýlu minimalizmu s dekoráciami z pohľadového betónu.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Strom1.jpg",
          "../src/assets/Strom 2.jpg",
