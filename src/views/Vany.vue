    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-sviecka-vany">Betónová sviečka VANY</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová sviečka VANY</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónová sviečka VANY je jedinečná kombinácia surového betónu a jemného svetla, ktorá prinesie moderný nádych do vášho interiéru. Minimalistický dizajn a prirodzený vzhľad robia z tejto sviečky nielen štýlový doplnok, ale aj originálny darček. Ideálna na relaxačné večery alebo ako dekorácia do akéhokoľvek priestoru.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Vany1.jpeg",
          "../src/assets/Vany2.jpeg",
          "../src/assets/Vany3.jpeg",
          "../src/assets/Vany4.jpeg",
          "../src/assets/Vany5.jpeg",
          "../src/assets/Vany6.jpeg",
          "../src/assets/Vany7.jpeg",
