    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-podlozka-lapi">Betónová podložka LAPI</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová podložka LAPI</h2>
          <div class="underline"></div>
          <p>
            <br>
            Multifunkčná podložka z pohľadového betónu oživí vkusom vašu kúpeľňu a usporiada všetko na svoje miesto. Ďalšie využitie nájde ako zásobník na kľúče, peňaženku či iné drobnosti vo vašej predsieni. Ak milujete poriadok, betónová podložka LAPI je práve pre vás.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Lapi1.jpg",
          "../src/assets/Lapi2.jpg",
          "../src/assets/Lapi3.jpg",
          "../src/assets/Lapi4.jpg",
          "../src/assets/Lapi5.jpg",
          "../src/assets/Lapi6.jpg",
          "../src/assets/Lapi7.jpg",
        ],
