      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/betonove-stierky/dekoracna-stierka">Dekoračná stierka</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Dekoračná betónová stierka je ideálnym riešením pre tých, ktorí chcú do svojho interiéru vniesť moderný a industriálny vzhľad. Vytvára jemne štruktúrovaný povrch s prirodzeným betónovým efektom, ktorý dodáva priestoru charakter a hĺbku. Stierka je vhodná na steny aj stropy a ponúka vysokú odolnosť, ľahkú údržbu a širokú škálu farebných odtieňov. Perfektná voľba pre elegantné, nadčasové a originálne dekoratívne riešenia.",
          itemsHeading:
