    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-predlzovacka-contraho">Betónová predlžovačka CONTRAHO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová podložka CONTRAHO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Aby vám už kábel v kancelárii nepadal zo stola na zem, vyrobili sme pre vás túto funkčnú predlžovaciu šnúru. Okrem dizajnu ponúka aj účelovosť vo forme záťaže na papiere a priblíženia elektrického pripojenia.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Contraho1.jpg",
          "../src/assets/Contraho2.jpg",
          "../src/assets/Contraho3.jpg",
          "../src/assets/Contraho4.jpg",
          "../src/assets/Contraho5.jpg",
