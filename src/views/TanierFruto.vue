    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-tanier-fruto">Betónový tanier FRUTO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový tanier FRUTO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónová misa v obdĺžnikovom tvare má bohaté praktické využitie a navyše v domácnosti spĺňa aj estetickú funkciu. Jej farebné prevedenie zaručí, že zapadne do každého interiéru či exteriéru. Aj miska môže byť módnou záležitosťou.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Fruto1.jpg",
          "../src/assets/Fruto2.jpg",
          "../src/assets/Fruto3.jpg",
          "../src/assets/Fruto4.jpg",
          "../src/assets/Fruto5.jpg",
          "../src/assets/Fruto6.jpg",
          "../src/assets/Fruto7.jpg",
