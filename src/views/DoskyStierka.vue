      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/nabytok/kuchynske-dosky-stierka">Kuchynské dosky stierka</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img
              src="../assets/kuchynske-dosky-stierka.jpg"
              alt="Renit Beton Image"
            />
          </div>
          <h1 class="vertical-text">renit beton</h1>
          <div class="info-content">
            <h2>Kuchynské dosky stierka</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Kuchynské dosky stierka sú štýlovým a praktickým riešením pre každú modernú kuchyňu. Povrchová úprava stierkou dodáva doskám jemnú textúru a originálny vzhľad, ktorý sa dokonale hodí k minimalistickému alebo industriálnemu štýlu. Vyznačujú sa vysokou odolnosťou voči vlhkosti a opotrebeniu, ľahkou údržbou a jedinečným dizajnom, ktorý vynikne v každom interiéri. Skvelá voľba pre tých, ktorí chcú spojiť funkčnosť s estetikou.",
          itemsHeading:
