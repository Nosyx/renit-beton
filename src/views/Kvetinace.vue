    ...
    <div>
      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            <li><a href="/">Úvod</a></li>
            <li><span>></span></li>
            <li><a href="/kvetinace">Kvetináče</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img src="../assets/kvetinac-1.jpg" alt="Renit Beton Image" />
          </div>
          <h1 class="vertical-text">renit beton</h1>
          <div class="info-content">
            <h2>kvetináče a záhony</h2>
      ...
      <div class="section-container">
        <div class="vertical-text-section">
          <h1 class="vertical-text-obklady">kvetináče</h1>
        </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        items: [
          {
            imgSrc: "src/assets/kvetinace-skladane.jpg",
            altText: "Kvetináče skladané",
            title: "Kvetináče skladané",
            link: "/kvetinace/kvetinace-skladane",
          },
          {
            imgSrc: "src/assets/kvetinace-monoliticke.jpg",
            altText: "Kvetináče monolitické",
            title: "Kvetináče monolitické",
            link: "/kvetinace/kvetinace-monoliticke",
          },
          {
            imgSrc: "src/assets/kvetinacove-steny.jpg",
            altText: "Kvetináčová stena",
            title: "Kvetináčová stena",
            link: "/kvetinace/kvetinacova-stena",
          },
          {
            imgSrc: "src/assets/vyvysene-zahony.jpg",
            altText: "Vyvýšené záhony",
            title: "Vyvýšené záhony",
            link: "/kvetinace/vyvysene-zahony",
          },
        ],
        text: {
          mainDescription:
            "Otvorte brány kreativity do vašej záhrady, terasy, parku či mesta s našimi betónovými kvetináčmi a vyvýšenými záhonmi. Jednoduchosť a chladnosť pohľadového betónu nechá vyniknúť kráse vašich rastlín. S betónovým kvetináčom nezískate len nádobu na kvety, ale aj originálny prvok do navrhnutého priestoru.  Pomocou robustného dizajnu tak vytvoríte záhradu plnú charakteru a šarmu. Materiál je navyše absolútne odolný voči vode a vonkajším vplyvom prostredia.",
          itemsHeading:
