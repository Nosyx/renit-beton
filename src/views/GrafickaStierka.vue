      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/betonove-stierky/graficka-stierka">Grafická stierka</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Grafická betónová stierka je unikátny dekoratívny prvok, ktorý spája moderný dizajn s kreatívnou originalitou. Umožňuje vytvárať jedinečné vzory, textúry a grafické motívy priamo na povrchu stien, čím dodáva priestoru osobitý a umelecký charakter. Vhodná do interiérov aj exteriérov, grafická stierka vyniká odolnosťou, ľahkou údržbou a možnosťou prispôsobenia podľa vašich predstáv. Perfektná voľba pre tých, ktorí hľadajú výrazný a sofistikovaný vizuálny efekt.",
          itemsHeading:
