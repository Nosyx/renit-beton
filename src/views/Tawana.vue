    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/prirucny-stolik-tawana">Príručny stolík TAWANA</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Príručny stolík TAWANA</h2>
          <div class="underline"></div>
          <p>
            <br>
            Príručný stolík TAWANA je dokonalým spojením minimalistického dizajnu a funkčnosti. Jeho pevná betónová konštrukcia zaručuje stabilitu a odolnosť, zatiaľ čo čisté línie a moderný vzhľad ho robia univerzálnym doplnkom do každého interiéru. Ideálny na odkladanie kníh, kávy či dekorácií, TAWANA prinesie do vášho priestoru štýlový a praktický prvok.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Tawana1.jpeg",
          "../src/assets/Tawana2.jpeg",
          "../src/assets/Tawana3.jpeg",
          "../src/assets/Tawana4.jpeg",
