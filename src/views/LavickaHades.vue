    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/lavicky-sedenie/lavicka-hades">Lavička HÁDES</a></li>
        </ul>
      </div>
    </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
            Sedenie z pohľadového betónu môže byť vhodným riešením pre váš byt alebo terasu. Pohľadový betón je výborným materiálom, čo sa týka vzhľadu aj funkčnosti. Je vysokoodolný voči vode či ohňu, pevný a navyše sa hodí ku všetkému. Ponúkame verzie s drevom a čalúneným sedákom pre ešte väčšie pohodlie.
        </p>
        <p>
          výška 450 mm<br /><br />
          dĺžka 1500 mm<br /><br />
          ...
          drevo: smrek – možnosť výberu podľa želania zákazníka, možnosť iných
          rozmerov na dopyt
        </p>
