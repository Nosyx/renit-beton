<template>
    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        ...
        <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/schody/schody-l-profil">Schody - L profil</a></li>
        </ul>
      </div>
    </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        <h1>Schody - L profil</h1>
        <div class="underline"></div>
        <p>
          Betónové schody L profil predstavujú moderné a elegantné riešenie pre interiérové aj exteriérové priestory. Ich čistý a minimalistický dizajn v tvare písmena L dodáva priestoru vzdušnosť a sofistikovaný vzhľad. Vyznačujú sa vysokou pevnosťou, odolnosťou a precíznym spracovaním, vďaka čomu sú ideálne pre moderné architektonické projekty. Schody L profil ponúkajú kombináciu funkčnosti, estetického vzhľadu a dlhej životnosti.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "/src/assets/schody-l-profil.jpg",
      ],
