    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-podnos-valentin">Betónový podnos Valentin</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový podnos Valentin</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónový podnos Valentin je štýlový a funkčný doplnok, ktorý vynikne v každom interiéri. Jeho elegantný dizajn a jemné línie spájajú modernú estetiku s praktickým využitím. Ideálny na servírovanie kávy, čaju či drobných pochúťok, ale aj ako dekoratívny podnos na sviečky či šperky. Robustný a odolný, no zároveň jedinečne sofistikovaný.<br><br><br>
          </p>
