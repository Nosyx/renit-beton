      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/obklady/obklad/mozaika">Mozaika</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img src="../assets/pod-obklad-mozaika.jpg" alt="Renit Beton Image" />
          </div>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Obklad Mozaika kombinuje precízne remeselné spracovanie a modernú eleganciu. Každý kus je vyrobený z kvalitného betónu, ktorý vytvára jedinečný textúrny efekt a dodáva priestoru charakter. Ideálny na steny v kúpeľni, kuchyni či ako dekoratívny prvok v interiéri. Mozaika prináša nadčasový dizajn s dôrazom na detaily, ktorý zaujme na prvý pohľad.",
          itemsHeading:
