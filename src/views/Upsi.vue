    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-sanon-zakladac-upsi">Betónový šanón/zakladač UPSI</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový šanón/zakladač UPSI</h2>
          <div class="underline"></div>
          <p>
            <br>
            Vašej kancelárii či pracovnému stolu dodá zakladač z pohľadového betónu štipku vkusu a praktickosti. Hodí sa na pracovné papiere, časopisy, brožúry či letáky pre zákazníka a vynikne v showroome vašej firmy.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Upsi1.jpg",
          "../src/assets/Upsi2.jpg",
          "../src/assets/Upsi3.jpg",
