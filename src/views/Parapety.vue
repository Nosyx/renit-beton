    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/parapety">Parapety</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">parapety</div>
        </div>
      </div>
      <div class="right-side">
        ...
        <p>
            Betónové parapety sú ideálnym riešením na vaše okná. Pohľadový betón je moderný, dizajnovo zaujímavý a praktický z hľadiska údržby. Je vysokoodolný voči vode a vlhkosti. Parapety ponúkame aj s odkvapovou drážkou, ktorá sa postará o nadbytočnú vodu.
        </p>
