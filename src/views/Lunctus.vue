    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-misa-lunctus">Betónová misa LUNCTUS</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová misa LUNCTUS</h2>
          <div class="underline"></div>
          <p>
            <br>
            Neodolateľná betónová misa v oblom tvare nájde svoje opodstatnenie v každej miestnosti domácnosti. Svojím nenúteným a minimalistickým vzhľadom dotvorí ľubovoľný interiér aj exteriér. Ideálna je aj pre nešikovných vďaka skvelej odolnosti betónu voči nárazom a poškriabaniu. Vkusného odkladacieho priestoru nie je doma nikdy dosť.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Lunctus1.jpg",
          "../src/assets/Lunctus2.jpg",
          "../src/assets/Lunctus3.jpg",
