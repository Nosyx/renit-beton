  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li><a href="/obklady/obklad-tryx">Betónový obklad KLASIK</a></li>
      </ul>
    </div>
  </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">obklady</div>
        </div>
      </div>
      <div class="right-side">
        <h1>Betónový obklad</h1>
        <h2>KLASIK</h2>
        <div class="underline"></div>
        <p>
          Obklady z pohľadového betónu sa v poslednom čase stali neoddeliteľnou
          súčasťou modernej architektúry. Predstavujú funkčný a zároveň
          dekoratívny prvok v interiéri aj exteriéri. Pohľadový betón sa výborne
          dopĺňa s drevom, kovom či sklom a podčiarkuje ich vzhľad. Aplikácia
          podkladov je vhodná na vertikálne aj horizontálne plochy.
        </p>
    ...
    <div class="formats-container">
      ...
      <div class="formats-content">
        ...
        <p class="formats-description">
          Zoznam formátov obkladov zahŕňa všetky vhodné a šaty, vlastné formy,
          odtlačové a montážne vzory. Tieto formáty umožňujú prispôsobiť dizajn
          každému priestoru, aby vznikla estetická hodnota a funkčnosť obkladov.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "/src/assets/obkladklasik1.jpg",
        "/src/assets/obklad-beton-klasik.jpeg",
        "/src/assets/obkladklasik2.jpg",
        "/src/assets/obkladklasik3.jpg",
        "/src/assets/obkladklasik4.jpg",
        "/src/assets/obkladklasik5.jpg",
        "/src/assets/obkladklasik6.jpg",
        "/src/assets/obkladklasik7.jpg",
        "/src/assets/obkladklasik8.jpg",
        "/src/assets/obkladklasik9.jpg",
      ],
