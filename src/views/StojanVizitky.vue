    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-stojan-na-vizitky-card">BETÓNOVÝ STOJAN NA VIZITKY CARD</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>BETÓNOVÝ STOJAN NA VIZITKY CARD</h2>
          <div class="underline"></div>
          <p>
            <br>
            Jednoduchý a praktický stojan na vizitky. Svoje využitie nájde v kancelárii, na recepcii, ale aj v obchode. Zviditeľnite sa držiakom z pohľadového betónu.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/betonovy-stojan-na-vizitky-card.jpg",
          "../src/assets/Betonovy-stojan-na-vizitky-CARD-1.jpg",
          "../src/assets/Betonovy-stojan-na-vizitky-CARD-2.jpg",
        ],
