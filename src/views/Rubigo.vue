    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-svietnik-rubigo">Betónový svietnik RUBIGO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový svietnik RUBIGO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Vďaka praktickému dvojitému dnu svietnika si môžete vybrať, akú sviečku doň vložíte. Či už sviečky čajové, alebo úzke vysoké, je len na vás, pre akú sa v danom okamihu rozhodnete a vylepšíte si ňou náladu.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Rubigo1.jpg",
          "../src/assets/Rubigo2.jpg",
          "../src/assets/Rubigo3.jpg",
          "../src/assets/Rubigo4.jpg",
          "../src/assets/Rubigo5.jpg",
          "../src/assets/Rubigo6.jpg",
          "../src/assets/Rubigo7.jpg",
