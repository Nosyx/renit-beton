  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li><a href="/obklady/obklad-tryx">Betónový obklad KRBU</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
          Cena je pre špecifickosť produktu individuálna. Pre viac informácii
          nám prosím, kontaktujte prostredníctvom formulára.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: ["/src/assets/obklad-krb.jpeg"],
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append(
        "message",
        `Betónový obklad KRBU kontaktný formulár- ${this.formData.message}`
      );
