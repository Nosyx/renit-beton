<template>
    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        ...
        <li><span>></span></li>
        <li><a href="/obklady/design-obklad">Design Obklad</a></li>
        <li><span>></span></li>
          <li><a href="/obklady/obklad-rezide">Betónový 3D obklad REZIDE</a></li>
        </ul>
      </div>
    </nav>
