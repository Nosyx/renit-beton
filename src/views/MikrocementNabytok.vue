      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/mikrocementove-stierky/mikrocementovy-nabytok">Mikrocementový nábytok</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img
              src="../assets/mikrocement-nabytok.jpg"
              alt="Renit Beton Image"
            />
          </div>
          <h1 class="vertical-text">renit beton</h1>
          <div class="info-content">
            <h2>mikrocementový nábytok</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Mikrocementový nábytok predstavuje spojenie moderného dizajnu a výnimočnej odolnosti. Každý kus je jedinečný, s hladkým povrchom a elegantnou textúrou, ktorá dodá vášmu interiéru industriálny a nadčasový štýl. Vhodný na využitie v obývačke, kuchyni či exteriéri, tento nábytok je odolný voči opotrebeniu, ľahko sa udržiava a ponúka širokú variabilitu tvarov a farebných odtieňov. Ideálna voľba pre tých, ktorí hľadajú originálny a praktický doplnok do svojho priestoru.",
          itemsHeading:
