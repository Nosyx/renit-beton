    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonove-domceky-city-3ks">Betónové domčeky CITY - 3ks</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónové domčeky CITY - 3ks</h2>
          <div class="underline"></div>
          <p>
            <br>
            Elegancia prevedená v čistých jednoduchých tvaroch, ktorá osvieži svojím minimalizmom. Pre vás vyrobíme v troch veľkostiach, a to: Veža/12,5x6,5x2,5; Chrám/11,5x7,5x2,5; Dom/9x6x2,5.<br><br><br>
          </p>
