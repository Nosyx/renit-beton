    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-miska-spice">Betónová miska SPICE</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová miska SPICE</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónová miska SPICE je elegantný doplnok, ktorý v sebe spája surovosť betónu a praktické využitie. Je ideálna na servírovanie drobných pochúťok, korenín či iných ingrediencií. Vďaka minimalistickému dizajnu a jedinečnej textúre skvele doplní modernú aj industriálnu kuchyňu či jedálenský stôl. Robustná, štýlová a funkčná.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Spice1.jpg",
          "../src/assets/Spice2.jpg",
          "../src/assets/Spice3.jpg",
          "../src/assets/Spice4.jpg",
          "../src/assets/Spice5.jpg",
          "../src/assets/Spice6.jpg",
          "../src/assets/Spice7.jpg",
