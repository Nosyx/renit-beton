    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-vianocna-ozdoba-quatro">Betónová vianočná ozdoba QUATRO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová vianočná ozdoba QUATRO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónová vianočná ozdoba QUATRO dodá vašim Vianociam moderný a elegantný nádych. Štýlový geometrický tvar a surový betón vytvárajú jedinečný kontrast s tradičnými sviatočnými dekoráciami. Ozdoba je odolná, minimalistická a skvele sa hodí na stromček, veniec alebo ako súčasť vianočného stolovania.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Quatro1.jpeg",
          "../src/assets/Quatro2.jpeg",
          "../src/assets/Quatro3.jpeg",
