  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
          Kvetináčová stena je dostupná vo viacerých odtieňoch a veľkostiach.
...
export default {
  ...
  data() {
    return {
      ...
      images: ["../src/assets/kvetinacova-stena.jpg"],
  ...
  methods: {
    ...
    submitForm() {
      ...
      formData.append(
        "message",
        `Kvetináčová STENA kontaktný formulár- ${this.formData.message}`
      );
