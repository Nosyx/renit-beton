    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/lavicky-sedenie/sedacka-comodus">Sedačka COMODUS</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">sedenie</div>
        </div>
      </div>
      <div class="right-side">
        ...
        <p>
          Comodus – záhradná sedačka je dokonalým spojením elegantného kovového rámu a moderného dizajnu. Táto štýlová sedačka je navrhnutá tak, aby poskytovala maximálny komfort a zároveň odolávala poveternostným podmienkam. Minimalistické línie a odolné materiály robia z Comodus ideálny doplnok pre vašu záhradu, terasu či balkón. Perfektné miesto na relax alebo posedenie s priateľmi.
        </p>
