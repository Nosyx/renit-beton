    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/kvetinace/kvetinacova-stena">Kvetináčová STENA</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          ...
          <p>
            Vkusný jednoduchý kvetináč, ktorý nechá vyniknúť vašu rastlinu. Jemný betónový dizajn ide ruka v ruka s jeho praktickosťou. Materiál je absolútne odolný voči vode, čiže ideálny na kvetináč. Prednosťou je aj jeho monolitická štruktúra, čo znamená, že je vytesaný z jedného kusu betónu.
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: ["../src/assets/kvetinace-monoliticke.jpg"],
    ...
    methods: {
      ...
      submitForm() {
        ...
        formData.append(
          "message",
          `Kvetináče MONOLITICKÉ kontaktný formulár- ${this.formData.message}`
        );
