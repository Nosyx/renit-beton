    ...
    <nav class="breadcrumbs">
      <div class="container">
        <ul>
          <li><a href="/">Úvod</a></li>
          <li><span>></span></li>
          <li><a href="/betonove-stierky">Betónové stierky</a></li>
        </ul>
      </div>
    </nav>
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          imgSrc: "src/assets/dekoracna-stierka.jpg",
          altText: "Dekoračná stierka",
          title: "Dekoračná stierka",
          link: "/betonove-stierky/dekoracna-stierka",
        },
        {
          imgSrc: "src/assets/graficka-stierka.jpg",
          altText: "Grafická stierka",
          title: "Grafická stierka",
          link: "/betonove-stierky/graficka-stierka",
        },
        {
          imgSrc: "src/assets/stierka-krbu.jpg",
          altText: "Stierka krbu",
          title: "Stierka krbu",
          link: "/betonove-stierky/stierka-krbu",
        },
        {
          imgSrc: "src/assets/beton-kozmetik.jpg",
          altText: "Betón kozmetik",
          title: "Betón kozmetik",
          link: "/betonove-stierky/beton-kozmetik",
        },
      ],
      text: {
        mainDescription:
