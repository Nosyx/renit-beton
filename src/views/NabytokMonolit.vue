      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/nabytok/nabytok-monoliticky">Nábytok monolitický</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img
              src="../assets/nabytok-monoliticky-main.jpg"
              alt="Renit Beton Image"
            />
          </div>
          <h1 class="vertical-text">renit beton</h1>
          <div class="info-content">
            <h2>Nábytok monolitický</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Monolitický nábytok je dokonalým spojením minimalistického dizajnu a pevnosti. Každý kus je vyrobený z jedného celistvého bloku betónu, čo zaručuje jeho odolnosť a jedinečný vzhľad. Ideálny pre moderné interiéry, v ktorých vynikne jeho surová estetika a jednoduché línie. Tento nábytok je nielen funkčný, ale aj štýlový, a prinesie do vášho priestoru nadčasový charakter.",
          itemsHeading:
