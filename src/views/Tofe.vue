    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-tanier-tofe">Betónový tanier TOFE</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový tanier TOFE</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónový dekoračný tanier. Elegantné riešenie ako štýlovo vyložiť ovocie/vajíčka, aby ste ich mali vždy po ruke. Betónová dekorácia v minimalistickom štýle.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Tofe1.jpg",
          "../src/assets/Tofe2.jpg",
          "../src/assets/Tofe3.jpg",
