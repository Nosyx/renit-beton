<template>
    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        ...
        <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/schody/schody-stupne">Schody stupne</a></li>
        </ul>
      </div>
    </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
          Betónové schodové stupne sú ideálnou voľbou pre vytvorenie odolných a estetických schodov v interiéri aj exteriéri. Vynikajú svojou pevnosťou, dlhou životnosťou a čistým dizajnom, ktorý sa hodí do moderných aj klasických priestorov. Schodové stupne sú precízne vyrobené s dôrazom na detail, čo zaručuje bezpečnosť a pohodlie pri používaní. Perfektné riešenie pre tých, ktorí hľadajú kombináciu funkčnosti a štýlu.
        </p>
