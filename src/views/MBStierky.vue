  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li>
          <a href="/mikrocementove-stierky/mikrocementove-betonove-stierky"
            >Mikrocementové betónové stierky</a
          >
        </li>
      </ul>
    </div>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">stierky</div>
        </div>
      </div>
      <div class="right-side">
        <h1>Mikrocementové betónové</h1>
        <h2>STIERKY</h2>
        <div class="underline"></div>
        <p>
          Cementová betónová stierka je ideálna na steny, pretože bude aj po
          rokoch dobre vyzerať, mikrocementovú stierku odporúčame zase na
          podlahy, fasádu, ale aj do sprchy, sauny alebo bazéna.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: ["../src/assets/m-stierka-2.jpg", "../src/assets/m-stierka.jpg"],
