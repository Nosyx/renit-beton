    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-nadoba-koluty">Betónová nádoba KOLUTY</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová nádoba KOLUTY</h2>
          <div class="underline"></div>
          <p>
            <br>
            Milé a jednoduché kvetináčiky oživia parapetu či stôl vo vašej kancelárii. Jednoducho umiestnite podľa svojho vkusu a je to.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Koluty1.jpg",
          "../src/assets/Koluty2.jpg",
          "../src/assets/Koluty3.jpg",
          "../src/assets/Koluty4.jpg",
          "../src/assets/Koluty5.jpg",
          "../src/assets/Koluty6.jpg",
