    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-lampa-luna">Betónová lampa LUNA</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová lampa LUNA</h2>
          <div class="underline"></div>
          <p>
            <br>
            Pohľadový betón v minimalistickom štýle vyjasní každý nočný stolík. Výborne ladí so sklom alebo aj s drevom.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Luna1.jpg",
          "../src/assets/Luna2.jpg",
