    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-kvetinacik-kristal">Betónový kvetináčik KRISTAL</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový kvetináčik KRISTAL</h2>
          <div class="underline"></div>
          <p>
            <br>
            Vymeňte bežné plastové kvetináče za industriálne betónové. Zasadiť do nich môžete jednoduchý kaktus, ale aj farebné kvetiny. Zladenie odtieňov betónu s prírodnými farbami kvetov nikto vo vašom interiéri neprehliadne.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Kristal1.jpg",
          "../src/assets/Kristal2.jpg",
          "../src/assets/Kristal3.jpg",
          "../src/assets/Kristal4.jpg",
          "../src/assets/Kristal5.jpg",
          "../src/assets/Kristal6.jpg",
