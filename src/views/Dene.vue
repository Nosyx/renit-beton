    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-stojan-dene">Betónový stojan DENE</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový stojan DENE</h2>
          <div class="underline"></div>
          <p>
            <br>
            Multifunkčný stojan z betónu nájde svoje využitie na kozmetickom stolíku ale aj vo vašej kúpeľni. Je praktickým stojanom na zubné kefky či kozmetické štetce.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Dene1.jpg",
          "../src/assets/Dene2.jpg",
          "../src/assets/Dene3.jpg",
          "../src/assets/Dene4.jpg",
          "../src/assets/Dene5.jpg",
