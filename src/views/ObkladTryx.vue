  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li>
          <a href="/obklady/design-obklad/obklad-tryx"
            >Betónový 3D obklad TRYX</a
          >
        </li>
      </ul>
    </div>
    ...
    <div class="formats-container">
      ...
      <div class="formats-content">
        ...
        <p class="formats-description">
          Zoznam formátov obkladov zahŕňa rôzne veľkosti a tvary, vrátane
          štvorcov, obdĺžnikov a mozaikových vzorov. Tieto formáty umožňujú
          prispôsobiť dizajn každému priestoru, čím zvyšujú estetickú hodnotu a
          funkčnosť obkladov.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "/src/assets/obklad-tryx.jpeg",
        "/src/assets/tryx2.jpeg",
        "/src/assets/tryx3.jpeg",
      ],
