      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/betonove-stierky/stierka-krb">Stierka krb</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Betónová stierka na krb je ideálna na vytvorenie moderného, odolného a estetického povrchu. Vďaka svojej tepelnej odolnosti je perfektnou voľbou pre obloženie krbov, pričom dodáva priestoru elegantný a minimalistický vzhľad. Stierka je dostupná v rôznych farebných odtieňoch a textúrach, čo umožňuje jej prispôsobenie vašim dizajnovým preferenciám. Jednoducho sa aplikuje, udržiava a zaručuje dlhodobú životnosť aj pri vysokých teplotách. Perfektné riešenie pre štýlové a funkčné krbové obklady.",
          itemsHeading:
