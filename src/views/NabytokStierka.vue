      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/nabytok/nabytok-stierka">Nábytok stierka</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Nábytok stierka prináša moderný dizajn s jemnou textúrou a sofistikovaným povrchom. Vďaka špeciálnej úprave stierkou získava každý kus originálny vzhľad, ktorý sa skvele hodí do industriálnych aj minimalistických interiérov. Nábytok je odolný, ľahko udržiavateľný a poskytuje jedinečnú kombináciu estetiky a funkčnosti. Ideálna voľba pre tých, ktorí hľadajú štýlové a praktické riešenie do svojho priestoru.",
          itemsHeading:
