    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-dekoracia-home">Betónová dekorácia HOME</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová dekorácia HOME</h2>
          <div class="underline"></div>
          <p>
            <br>
            Na želanie pre vás z pohľadového betónu vytvoríme mená vašich blízkych, názvy firiem alebo priezvisko novomanželov. Dekorácia sa hodí nielen do interiéru, ale aj na fasády budov či kancelárií. Cena za dekoráciu HOME.<br><br><br>
          </p>
