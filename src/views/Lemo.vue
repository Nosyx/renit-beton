    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-citronovnik-lemo">Betónový citrónovník LEMO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový citrónovník LEMO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Štýlová nádoba, ktorá očarí každú návštevu. Prirodzené farby betónu rozžiari limetka či citrón. Vďaka priesvitnému sklu na zakrývanie sa ovocie nevysuší.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Lemo1.jpg",
          "../src/assets/Lemo2.jpg",
          "../src/assets/Lemo3.jpg",
          "../src/assets/Lemo4.jpg",
          "../src/assets/Lemo5.jpg",
          "../src/assets/Lemo6.jpg",
