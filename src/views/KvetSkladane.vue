    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/kvetinace/kvetinace-skladane">Kvetináče SKLADANÉ</a></li>
        </ul>
      </div>
    </nav>
      ...
      <div class="content">
        <div class="left-side">
          <div class="main-image-container">
            ...
            <div class="vertical-text">kvetináče</div>
          </div>
        </div>
        <div class="right-side">
          ...
          <p>
            Nádoba na kvety z pohľadového betónu je tou pravou voľbou, keď máte radi moderný a ľahko kombinovateľný dizajn. Vaše rastliny vďaka betónovému črepníku krásne vyniknú. Výhodou betónu je, že je maximálne odolný voči vode, a teda bezkonkurenčným materiálom v záhradkárstve. Ponúkame vo viacerých farebných prevedeniach.
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: ["../src/assets/kvetinace-skladane-1.jpg"],
    ...
    methods: {
      ...
      submitForm() {
        ...
        formData.append(
          "message",
          `Kvetináče SKLADANÉ kontaktný formulár- ${this.formData.message}`
        );
