    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-zasobnik-na-vatove-tycinky-auris">BETÓNOVÝ ZÁSOBNÍK NA VATOVÉ TYČINKY AURIS</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>BETÓNOVÝ ZÁSOBNÍK NA VATOVÉ TYČINKY AURIS</h2>
          <div class="underline"></div>
          <p>
            <br>
            Zameňte plastové nádoby na vatové tyčinky za vkusnú náhradu z betónu. Vybrať si môžete z troch farieb a doladiť tak interiér vašej kúpeľne. Zásobník je odolný voči vode a nepotrebuje takmer žiadnu údržbu.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/betonovy-zasobnik-na-vatove-tycinky.jpg",
          "../src/assets/Betonovy-zasobnik-na-vatove-tycinky-AURIS_1.jpg",
          "../src/assets/Betonovy-zasobnik-na-vatove-tycinky-AURIS_2-1200x800-1-1024x683.jpg",
          "../src/assets/Betonovy-zasobnik-na-vatove-tycinky-AURIS_antracit-1200x800-1-1024x683.jpg",
          "../src/assets/Betonovy-zasobnik-na-vatove-tycinky-AURIS_biela-1200x800-1-1024x683.jpg",
          "../src/assets/Betonovy-zasobnik-na-vatove-tycinky-AURIS_sive-1200x800-1-1024x683.jpg",
        ],
