  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li><a href="/obklady/obklad-tryx">Betónový 3D obklad PLOTU</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
          Betónový plot je trvácny, vydrží dlhé roky a nemusíte sa trápiť s jeho
          údržbou či opravami. Vybrať si môžete napríklad betónový obklad,
          rôznych rozmerov a odtieňov. Cena je pre špecifickosť produktu
          individuálna. Pre viac informácii nám prosím, kontaktujte
        ...
        <form @submit.prevent="submitForm" class="contact-form">
          <label for="name">Vaše meno (povinné)</label>
          <input
            type="text"
            id="name"
          ...
          <label for="email">Váš email (povinné)</label>
          <input
            type="email"
            id="email"
          ...
          <button type="submit" class="submit-button">Odošli</button>
        </form>
        <!-- Koniec formulára -->
      </div>
    </div>
...
export default {
  ...
  data() {
    return {
      ...
      images: ["/src/assets/obklad-beton-plot.jpeg"],
    };
  },
  methods: {
    handleButtonClick() {
    ...
    submitForm() {
      ...
      formData.append(
        "message",
        `Betónový obklad PLOTU kontaktný formulár- ${this.formData.message}`
      );

      fetch("https://formsubmit.co/renit@renit.sk", {
        method: "POST",
        body: formData,
      })
        .then((response) => {
