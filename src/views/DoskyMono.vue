      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/nabytok/kuchynske-dosky-monoliticke">Kuchynské dosky monolitické</a></li>
          </ul>
        </div>
      </nav>
      ...
      <section class="info-section">
        <div class="info-container">
          <div class="info-image">
            <img
              src="../assets/vyvysene-zahony.jpg"
              alt="Renit Beton Image"
            />
          </div>
          <h1 class="vertical-text">renit beton</h1>
          <div class="info-content">
            <h2>Kuchynské dosky monolitické</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Kuchynské dosky monolitické prinášajú do vašej kuchyne jedinečný moderný dizajn a mimoriadnu odolnosť. Ich bezšpárový povrch zaručuje jednoduchú údržbu, hygienu a dlhú životnosť. Monolitické prevedenie dodáva priestoru súčasný industriálny charakter, ktorý sa perfektne hodí do moderných aj minimalistických interiérov. Ideálne riešenie pre každého, kto hľadá funkčnosť spojenú s elegantným štýlom.",
          itemsHeading:
