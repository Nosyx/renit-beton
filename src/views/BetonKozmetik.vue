      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/betonove-stierky/beton-kozmetik">Betón kozmetik</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Betón Kozmetik je precízna úprava betónových povrchov, ktorá dodá schodom, stenám či iným betónovým prvkom dokonalý a estetický vzhľad. Jemné detaily a hladký povrch zdôraznia moderný dizajn a prinesú do vášho interiéru alebo exteriéru nadčasovú eleganciu. Ideálne pre tých, ktorí vyžadujú špičkovú kvalitu a vizuálnu dokonalosť.",
          itemsHeading:
