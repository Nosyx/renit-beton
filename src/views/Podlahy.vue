    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">podlahy</div>
        </div>
      </div>
      <div class="right-side">
        ...
        <p>
          Oživte svoj domov podlahami či stierkami z pohľadového betónu. Tieto betónové prvky sa stali obľúbenou súčasťou moderných interiérov i exreriérov, pomocou ktorých ľahko dosiahnete dychberúci industriálny štýl.
Naše betónové podlahy a stierky nie sú len estetickými prvkami, ale aj praktickými riešeniami pre každodenný život. Sú rezistentné voči vplyvu prostredia a jedinečné textúry robia z každého kroku nezabudnuteľný zážitok. Navyše sú odolné voči oderu a ich údržba je bezproblémová.
S našimi betónovými podlahami a stierkami vytvoríte harmonické spojenie medzi moderným dizajnom a funkčnosťou, vďaka čomu sa váš domov stane nielen estetický, ale aj pohodlný.
...
export default {
  ...
  data() {
    return {
      ...
      images: ["../src/assets/podlahy-2.jpg", "../src/assets/podlahy.jpg"],
