    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-svietnik-invent">Betónový svietnik INVENT</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový svietnik INVENT</h2>
          <div class="underline"></div>
          <p>
            <br>
            Vychutnajte si atmosféru pohodového večera. Okrem voňavých čajových sviečok si užite aj dizajn svietnikov z pohľadového betónu. Na objednávku vám pripravíme rôzne farebné prevedenia.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Invent1.jpg",
          "../src/assets/Invent2.jpg",
          "../src/assets/Invent3.jpg",
          "../src/assets/Invent4.jpg",
          "../src/assets/Invent5.jpg",
          "../src/assets/Invent6.jpg",
          "../src/assets/Invent7.jpg",
