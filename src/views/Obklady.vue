...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          imgSrc: "src/assets/pod-obklad.jpg",
          altText: "Obklad",
          title: "Obklad",
          link: "/obklady/obklad/",
        },
        {
          imgSrc: "src/assets/pod-dizajn-obklad.jpg",
          altText: "Design obklad",
          title: "Design obklad",
          link: "/obklady/design-obklad",
        },

        {
          imgSrc: "src/assets/pod-obklad-krbu.jpg",
          altText: "Obklad krbu",
          title: "Obklad krbu",
          link: "/obklady/obklad/obklad-krb",
        },
        {
          imgSrc: "src/assets/pod-obklad-mozaika.jpg",
          altText: "Mozaika",
          title: "Mozaika",
          link: "/obklady/obklad/mozaika",
        },
      ],
      text: {
        mainDescription:
        ...
        backText:
        "Vráťte sa späť do našej ponuky produktov",
      },
    };
  },
  methods: {
