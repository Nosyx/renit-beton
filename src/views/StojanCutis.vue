    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-stojan-dekorativnej-kozmetiky-cutis">Betónový stojan dekoratívnej kozmetiky CUTIS</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový stojan dekoratívnej kozmetiky CUTIS</h2>
          <div class="underline"></div>
          <p>
            <br>
            Kozmetické štetce, rúže a iné líčidlá na jednom mieste. Elegantné prevedenie stojana z pohľadového betónu v sivom, antracitovom, bielom alebo ružovom prevedení sa hodí do vašej kúpeľne ale aj na nočný stolík.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Cutis1.jpg",
          "../src/assets/Cutis2.jpg",
          "../src/assets/Cutis3.jpg",
          "../src/assets/Cutis4.jpg",
          "../src/assets/Cutis5.jpg",
          "../src/assets/Cutis6.jpg",
