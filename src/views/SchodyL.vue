  ...
  <nav class="breadcrumbs">
    <div class="container-bd">
      <ul>
        ...
        <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/schody-l">Schody „L“</a></li>
      </ul>
    </div>
  </nav>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="right-side">
        ...
        <p>
          Jednoduché a zároveň štýlové schody, ktoré sa hodia do každého typu
          interiéru. Primeraná výška schodu je vhodná a dobre schodná pre všetky
          vekové kategórie. Betónové schody ponúkame vo viacerých farebných
          prevedeniach.
        </p>
    ...
    <div class="formats-container">
      ...
      <div class="formats-content">
        ...
        <p class="formats-description">
          Zoznam formátov schodov a parapetov zahŕňa rôzne veľkosti a tvary,
          vrátane štvorcov, obdĺžnikov a mozaikových vzorov. Tieto formáty
          umožňujú prispôsobiť dizajn každému priestoru, čím zvyšujú estetickú
          hodnotu a funkčnosť schodov a parapetov.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      images: [
        "../src/assets/schody-l-1.jpg",
        "../src/assets/schody-l.jpg",
        "../src/assets/schody-l-2.jpg",
        "../src/assets/schody-l-3.jpg",
      ],
  ...
  methods: {
    handleButtonClick() {
      if (window.innerWidth < 1000) {
        ...
        link.download = "zoznam-formatov-schodov-a-parapetov.pdf";
        link.click();
      } else {
