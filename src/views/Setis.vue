    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-wc-kefa-setis">Betónová WC kefa SETIS</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová WC kefa SETIS</h2>
          <div class="underline"></div>
          <p>
            <br>
            Kefa na toaletu musí byť prítomná v každej domácnosti, no nemusí byť nenápadne schovaná. Zadovážte si štýlovú betónovú kefu vo viacerých farebných prevedeniach a môžete ju na záchode doslova vystaviť. Okrem lákavého vzhľadu je aj praktická vzhľadom na skvelú odolnosť betónu voči vode.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Setis1.jpg",
          "../src/assets/Setis2.jpg",
