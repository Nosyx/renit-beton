    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/ploty">Ploty</a></li>
        <li><span>></span></li>
        <li><a href="/schody-ploty-capice-parapety/ploty/panely">Panely</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">ploty</div>
        </div>
      </div>
      <div class="right-side">
        ...
        <p>
          Betónové plotové panely sú ideálnym riešením pre tých, ktorí hľadajú odolný, bezpečný a estetický plot. Vyznačujú sa moderným dizajnom, čistými líniami a dlhou životnosťou, vďaka čomu poskytujú spoľahlivú ochranu a zároveň vylepšujú vzhľad vášho exteriéru. Dostupné v rôznych vzoroch a veľkostiach, umožňujú prispôsobiť plot presne podľa vašich potrieb a štýlu. Perfektná kombinácia funkčnosti a elegantného dizajnu.
        </p>
