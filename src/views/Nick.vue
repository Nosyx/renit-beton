    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonovy-zajac-nick">Betónový zajac NICK</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónový zajac NICK</h2>
          <div class="underline"></div>
          <p>
            <br>
            Dekorácia z pohľadového betónu, pre každý interiér. Zajac NICK môže mat rôzne farby, predstavivosť nemá hranice.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Nick1.jpeg",
          "../src/assets/Nick2.jpeg",
