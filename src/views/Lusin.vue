    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-misa-lusin">Betónová misa LUSIN</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová misa LUSIN</h2>
          <div class="underline"></div>
          <p>
            <br>
            Neodolateľná betónová misa, ktorej každý rád nájde svoje miesto. Svojim nenúteným vzhľadom dotvorí každý interiér i exteriér.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Lusin1.jpg",
          "../src/assets/Lusin2.jpg",
          "../src/assets/Lusin3.jpg",
          "../src/assets/Lusin4.jpg",
          "../src/assets/Lusin5.jpg",
          "../src/assets/Lusin6.jpg",
          "../src/assets/Lusin7.jpg",
          "../src/assets/Lusin8.jpg",
          "../src/assets/Lusin9.jpg",
          "../src/assets/Lusin10.jpg",
          "../src/assets/Lusin11.jpg",
