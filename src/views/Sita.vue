    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-misa-sita">Betónová misa SITA</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová misa SITA</h2>
          <div class="underline"></div>
          <p>
            <br>
            Jedinečnosť minimalistického vzhľadu.<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Sita1.jpg",
          "../src/assets/Sita2.jpg",
          "../src/assets/Sita3.jpg",
          "../src/assets/Sita4.jpg",
          "../src/assets/Sita5.jpg",
          "../src/assets/Sita6.jpg",
          "../src/assets/Sita7.jpg",
