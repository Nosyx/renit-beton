      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/mikrocementove-stierky/mikrocementova-stena">Mikrocementová stena</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Mikrocementová stena je dokonalým riešením pre vytvorenie moderného a elegantného vzhľadu v interiéri aj exteriéri. Vďaka bezšpárovému povrchu a jemnej textúre dodáva priestorom jedinečný charakter. Je odolná voči vlhkosti a ľahko sa udržiava, čo ju robí ideálnou voľbou pre kúpeľne, kuchyne či obývacie priestory. Široká škála farebných odtieňov a povrchových úprav umožňuje prispôsobiť stenu presne podľa vašich predstáv. Perfektná kombinácia estetiky a funkčnosti.",
          itemsHeading:
