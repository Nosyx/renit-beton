    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          <li><a href="/">Úvod</a></li>
          <li><span>></span></li>
          <li><a href="/lavicky-sedenie">Lavičky/ Sedenie</a></li>
          <li><span>></span></li>
          <li><a href="/lavicky-sedenie/lavicka-apolon">Lavička APOLÓN</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">lavičky</div>
        </div>
      </div>
      <div class="right-side">
        ...
        <p>
          Sedenie z pohľadového betónu môže byť vhodným riešením pre váš byt alebo terasu. Pohľadový betón je výborným materiálom, čo sa týka vzhľadu aj funkčnosti. Je vysokoodolný voči vode či ohňu, pevný a navyše sa hodí ku všetkému. Ponúkame verzie s drevom a čalúneným sedákom pre ešte väčšie pohodlie. <br><br>výška  450 mm<br><br>
            dĺžka 2170 mm<br><br>
            šírka 450 mm<br><br>
            váha 190,77 kg<br><br>
            drevo: smrek – možnosť výberu podľa želania zákazníka, možnosť iných rozmerov na dopyt
        </p>
