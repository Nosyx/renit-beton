    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/schody-ploty-capice-parapety/betonova-stierka-plotu">Betónová stierka plotu</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h1>Betónová stierka</h1>
          <h2>PLOTU</h2>
          <div class="underline"></div>
          <p>
            Betónová stierka plotu sa vyznačuje vlastnosťami, ktoré odolajú nepríjemným poveternostným podmienkam a ešte aj vyzerá skvelo. Cena je pre špecifickosť produktu individuálna. Pre viac informácii nám prosím, kontaktujte prostredníctvom formulára.
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: ["../src/assets/stierka-plot.jpg"],
    ...
    methods: {
      ...
      submitForm() {
        ...
        formData.append(
          "message",
          `Betónová stierka PLOTU kontaktný formulár- ${this.formData.message}`
        );
