    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dlazby/design-dlazba">Design Dlažba</a></li>
        </ul>
      </div>
    </nav>
    ...
    <section class="formats-section">
      <div class="formats-container">
        ...
        <div class="formats-content">
          <h2 class="formats-title">formáty dlažbyjh</h2>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "/src/assets/DesignDlazba1.jpg",
          "/src/assets/DesignDlazba2.jpg",
          "/src/assets/DesignDlazba3.jpg",
        ],
