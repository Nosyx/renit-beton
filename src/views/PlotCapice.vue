    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/schody-ploty-capice-parapety/plotove-capice">Plotové čapice</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="content">
      <div class="left-side">
        <div class="main-image-container">
          ...
          <div class="vertical-text">čapice</div>
        </div>
      </div>
      <div class="right-side">
        <h1>Plotové čapice</h1>
        <div class="underline"></div>
        <p>
          Plotové čapice sú elegantným a praktickým zakončením každého plotu. Vyrobené z odolného betónu, poskytujú spoľahlivú ochranu pred poveternostnými vplyvmi a zároveň dodávajú plotu upravený a estetický vzhľad. Ich čisté línie a univerzálny dizajn sa hodia k rôznym typom plotových konštrukcií, čím zvyšujú celkovú hodnotu a štýl vášho exteriéru.
        </p>
...
export default {
  ...
  data() {
    return {
      ...
      pdfVisible: false,
      pdfSrc: "../src/assets/pdf/zoznam-formatov-schodov-a-parapetov.pdf", // Nahraďte cestou k PDF súboru
      isLightboxOpen: false,
      images: [
        "../src/assets/CapiceMain.jpg",
      ],
