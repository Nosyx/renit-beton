    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/dekoracie/betonova-mydelnicka-sapo">Betónová mydelnička SAPO</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h2>Betónová mydelnička SAPO</h2>
          <div class="underline"></div>
          <p>
            <br>
            Betónová mydelnička SAPO<br><br><br>
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/Sapo1.jpg",
          "../src/assets/Sapo2.jpg",
          "../src/assets/Sapo3.jpg",
          "../src/assets/Sapo4.jpg",
          "../src/assets/Sapo5.jpg",
          "../src/assets/Sapo6.jpg",
          "../src/assets/Sapo7.jpg",
