    ...
    <nav class="breadcrumbs">
      <div class="container">
        <ul>
          <li><a href="/">Úvod</a></li>
          <li><span>></span></li>
          <li><a href="/nabytok">Kuchynské dosky/nábytok</a></li>
        </ul>
      </div>
    </nav>
    ...
    <section class="info-section">
      <div class="info-container">
        <div class="info-image">
          <img src="../assets/nabytok-vnutorna-titulka.jpg" alt="Renit Beton Image" />
        </div>
        <h1 class="vertical-text">renit beton</h1>
        <div class="info-content">
          <h2>Kuchynské dosky/nábytok</h2>
...
export default {
  ...
  data() {
    return {
      ...
      items: [
        {
          imgSrc: "src/assets/kuchynska-doska-2.jpg",
          altText: "Kuchynské dosky monolitické",
          title: "Kuchynské dosky monolitické",
          link: "/nabytok/kuchynske-dosky-monoliticke",
        },
        {
          imgSrc: "src/assets/kuchynske-dosky-stierka.jpg",
          altText: "Kuchynské dosky stierka",
          title: "Kuchynské dosky stierka",
          link: "/nabytok/kuchynske-dosky-stierka",
        },
        {
          imgSrc: "src/assets/nabytok-monoliticky-main.jpg",
          altText: "Nábytok monolitický",
          title: "Nábytok monolitický",
          link: "/nabytok/nabytok-monoliticky",
        },
        {
          imgSrc: "src/assets/stierka-nabytok.jpg",
          altText: "Nábytok stierka",
          title: "Nábytok stierka",
          link: "/nabytok/nabytok-stierka",
        },
      ],
      text: {
        mainDescription:
          "Vložte do svojej kuchyne dotyk industriálnej elegancie s našimi kuchynskými doskami a nábytkom z pohľadového betónu.  Betónové kuchynské dosky si so sebou nesú odolnosť voči vode, vysokým teplotám a poškriabaniu. Zároveň oceníte štýlový vzhľad, ktorý pretransformuje vašu kuchyňu na miesto, kde budete cítiť ako profesionálny šéfkuchár. Či už máte kuchynskú linku v elegantnom talianskom dizajne alebo vás očaril vidiecky štýl, betónovou pracovnou doskou rozhodne nešliapnete vedľa. Vedľa nešliapnete ani s našimi stolmi či iným nábytkom z pohľadového betónu. Vyniknúť tak môžu či už vo vašej kuchyni, jedálni alebo kdekoľvek inde. Ich originálny a zároveň minimalistický dizajn ozvláštni každý priestor.",
        itemsHeading:
