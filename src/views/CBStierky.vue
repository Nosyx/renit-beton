    ...
    <nav class="breadcrumbs">
      <div class="container-bd">
        <ul>
          ...
          <li><span>></span></li>
          <li><a href="/mikrocementove-stierky/cementove-betonove-stierky">Cementové betónové stierky</a></li>
        </ul>
      </div>
    </nav>
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <div class="right-side">
          <h1>Cementové betónové</h1>
          <h2>STIERKY</h2>
          <div class="underline"></div>
          <p>
              Cementová betónová stierka je ideálna na steny, pretože bude aj po rokoch dobre vyzerať, mikrocementovú stierku odporúčame zase na podlahy, fasádu, ale aj do sprchy, sauny alebo bazéna.
          </p>
  ...
  export default {
    ...
    data() {
      return {
        ...
        images: [
          "../src/assets/c-stierka-2.jpg",
          "../src/assets/c-stierka.jpg",
        ],
