      ...
      <nav class="breadcrumbs">
        <div class="container">
          <ul>
            ...
            <li><span>></span></li>
            <li><a href="/mikrocementove-stierky/mikrocementova-fasada">Mikrocementová fasáda</a></li>
          </ul>
        </div>
      </nav>
  ...
  export default {
    ...
    data() {
      return {
        ...
        text: {
          mainDescription:
            "Mikrocementová fasáda je moderné riešenie pre tých, ktorí hľadajú štýlový a odolný povrch pre exteriér aj interiér. Tento materiál ponúka minimalistický vzhľad s jemnou textúrou, ktorý dodáva budovám elegantný a nadčasový charakter. Vyznačuje sa vysokou odolnosťou voči poveternostným vplyvom, ľahkou údržbou a širokou škálou farebných odtieňov, čo umožňuje prispôsobiť fasádu presne podľa vašich predstáv. Ideálna voľba pre moderné a industriálne architektonické projekty.",
          itemsHeading:
